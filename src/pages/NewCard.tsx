...
const NewCard = () => {
    const [cardTitle, setCardTitle] = useState<string>('This is the card title');
    const [cardContent, setCardContent] = useState<string>('This is the card content/description');
